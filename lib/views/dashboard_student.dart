                    ...
                    child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              onPressed: () async {
                                final url = 'https://www.unco.edu/tutoring/course-offerings/individual-tutoring-courses.aspx';
                                if (await canLaunch(url)) {
                                  await launch(url, forceSafariVC: false,);
                                }
                                else{
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => AskAQuestionView()),
                                );
                              },
                              child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                          ...
                          Container(
                            ...
                            child: RaisedButton(
                              onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(builder: (context) => StudentFAQView()),
                                );
                              },
                              child: Column(
                                  mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: RaisedButton.icon(
                      onPressed: () async {
                        final url = 'https://www.unco.edu/tutoring/pdf/night-time-drop-in-course-offerings.pdf';
                        if (await canLaunch(url)) {
                          await launch(url, forceSafariVC: false,);
                        }
                        else{
